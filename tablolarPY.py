...
def TABLO_6lı(liste: list, menüTipi: str = "Ana Menümmmm", listeTipi: str = "Ana Listemmmm"):
    ...
    table = Table(title=f"[bold yellow1]BULUNAN ÖĞRENCİLER TABLOSU[/] [thistle1]box_stili:[/]{altBox_stili[0]}",caption=f"{veri.value} dilimlenmiş tablo",box=altBox_stili[1],show_header=True,header_style="",)
